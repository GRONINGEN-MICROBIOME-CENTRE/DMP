...
run_gmhi_classifier <- function(input_data = input_data) {
  ...
  Healthy <- data[,colnames(data) %in% dat[dat$MED.DISEASES.None.No.Diseases %in% 1,]$sampleid]
  Nonhealthy <- data[,colnames(data) %in% dat[dat$MED.DISEASES.None.No.Diseases %in% 0,]$sampleid]
