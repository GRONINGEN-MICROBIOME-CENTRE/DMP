# ============================================
# ============================================
# MOCK Fig S2/b, implementation with MOCK data
# ============================================
# ============================================
...
#   Fig S2/b (piechart with phyla)
#   using MOCK data
# > use DMP_microbiome_FigS2B.R to generate the figure
#   used in the manscript from real data
...
#summTaxa <- summTaxa[order(summTaxa)]
meanTaxa <- (apply(inDFt,MARGIN=1,FUN= mean))
sdTaxa <- (apply(inDFt,MARGIN = 2,FUN = sd))
tblTaxa <- cbind.data.frame(meanTaxa,sdTaxa)
print(pieTaxa)
ggsave(plot = pieTaxa,filename = 'microbiome_description/plots/MockData_FigS2b_Piechart_Phyla.png',width = 10*1.1,height = 10)
write.table(tblTaxa,file = 'microbiome_description/plots/MockData_FigS2b_Piechart_Phyla_numbers.csv',sep=',')
